...
```typescript(components/Input/samples/i-inputs_2.tsx)
    clearcallback(){
      this.clearCounter += 1;
...
```typescript(components/Checkbox/samples/i-checkbox_2.tsx)
render() {
    return <i-panel>
        <i-checkbox
            caption = "Check me!" 
...
```typescript(components/Checkbox/samples/i-checkbox_1.tsx)
...
```typescript(components/TreeView/samples/i-tree-view_4.tsx)
const treeData: any[] = [
    {
        caption: 'Level one 1',
        children: [
...
```typescript(components/TreeView/samples/i-tree-view_5.tsx)
const treeData: any[] = [
    {
        caption: 'Level one 1',
        children: [
...
```typescript(components/BarChart/samples/i-bar-chart_1.tsx)
    var data = {
    title: {
        text: 'Bar Chart demo'
    },
...
```typescript(components/BarChart/samples/i-bar-chart_2.tsx)
    var data = {
    title: {
        text: 'Bar Chart demo'
    },
...
```typescript(components/BarChart/samples/i-bar-stack-chart.tsx)
    var data = {
        tooltip: {
            trigger: 'axis',
            axisPointer: {
...
```typescript(components/LineChart/samples/i-line-chart.tsx)
    render(){
        var data = {
            xAxis: {
                type: 'category',
...
```typescript(components/PieChart/samples/i-pie-chart.tsx)
    render(){
      var data = {
          title: {
...
```typescript(components/ScatterChart/samples/i-scatter-chart.tsx)
    render(){
        var data = {
            xAxis: {},
            yAxis: {},
...
```typescript(components/ScatterLineChart/samples/i-scatter-line-chart.tsx)
    render(){
      var data = [
          [96.24, 11.35],
          [33.09, 85.11],
...
## i-panel (Property)
```typescript(components/Panel/samples/i-panel.tsx)
  render() {
...
```typescript(components/CardLayout/samples/i-card-layout.tsx)
  render() {
    return <i-panel>
...
## i-vstack (Property)
```typescript(components/Vstack/samples/i-vstack.tsx)
  render() {
...
## i-hstack (Property)
```typescript(components/Hstack/samples/i-hstack.tsx)
  render() {
